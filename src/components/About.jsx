...
const About = () => {
  return (
    <div className="bg-[#f5f3ed] py-16 md:py-24 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            <p className="text-sm tracking-[0.2em] text-gray-600 uppercase">
              About Us
            </p>
            <div className="h-px w-12 bg-gray-400"></div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-20 md:mb-28">
          {/* Image */}
          <motion.div
