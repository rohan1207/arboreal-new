        ...
        >
          <div className="bg-white backdrop-blur-lg rounded-full shadow-2xl">
            <div className="flex flex-col md:flex-row items-stretch divide-y md:divide-y-0 md:divide-x divide-white/10">
              ...
              <div className="flex-1 px-6 py-4 md:py-5 flex items-center gap-3 min-w-0">
                <div className="flex-shrink-0">
                  <svg className="w-5 h-5 text-[#2a2a2a]/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex-1 px-6 py-4 md:py-5 min-w-0">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    >
                      <option value="1" className="bg-[#2a2a2a] text-white">1 Room</option>
                      <option value="2" className="bg-[#2a2a2a] text-white">2 Rooms</option>
                      <option value="3" className="bg-[#2a2a2a] text-white">3 Rooms</option>
                      <option value="4" className="bg-[#2a2a2a] text-white">4 Rooms</option>
                      <option value="5" className="bg-[#2a2a2a] text-white">5+ Rooms</option>
                    </select>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <select
                      ...
                      className="w-full text-[#2a2a2a] text-sm focus:outline-none bg-transparent font-light cursor-pointer appearance-none"
                    >
                      <option value="1" className="bg-[#2a2a2a] text-white">1 Adult</option>
                      <option value="2" className="bg-[#2a2a2a] text-white">2 Adults</option>
                      <option value="3" className="bg-[#2a2a2a] text-white">3 Adults</option>
                      <option value="4" className="bg-[#2a2a2a] text-white">4 Adults</option>
                      <option value="5" className="bg-[#2a2a2a] text-white">5+ Adults</option>
                    </select>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <select
                      ...
                      className="w-full text-[#2a2a2a] text-sm focus:outline-none bg-transparent font-light cursor-pointer appearance-none"
                    >
                      <option value="0" className="bg-[#2a2a2a] text-white">0 Children</option>
                      <option value="1" className="bg-[#2a2a2a] text-white">1 Child</option>
                      <option value="2" className="bg-[#2a2a2a] text-white">2 Children</option>
                      <option value="3" className="bg-[#2a2a2a] text-white">3 Children</option>
                      <option value="4" className="bg-[#2a2a2a] text-white">4+ Children</option>
                    </select>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-center px-6 py-4 md:py-3">
                <motion.button
                  ...
                  className="px-8 py-3.5 bg-[#2a2a2a] text-white rounded-full font-medium text-sm tracking-wide transition-all duration-300 hover:shadow-xl whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-100"
                >
                  {loading ? (
