  ...
  >
    <div className="p-4 sm:p-6">
      <div className="flex flex-col  lg:flex-row lg:items-center lg:justify-between gap-6 lg:gap-6">
        ...
        {/* Price & actions */}
        <div className="w-full lg:max-w-xs flex flex-col sm:flex-row lg:flex-col gap-4 sm:gap-6 lg:items-end">
          <div className="flex-1">
            <p className="text-2xl font-serif text-black mb-1">
              {room.currency_sign}
          ...
          <div className="flex flex-col sm:flex-1 gap-3">
            <button
              ...
              className="text-sm text-gray-700 underline hover:text-black text-left sm:text-center"
            >
              Booking policies
            </button>
